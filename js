	...
	document.getElementById("modeloLuna").onclick = function cambiarModeloLuna(){
		switch(modeloLuna) {
			case 1:
				...
				document.getElementById("modeloLuna").innerHTML="Luna semicirculo";
				modeloLuna=2;
				break;
			case 2:
				document.getElementById("luna").src="img/luna rara.jpg";
				document.getElementById("modeloLuna").innerHTML="Luna plana";
				modeloLuna=1;
				break;
			}
		}

	//CAMBIAR LA IMAGEN DE LA NAVE
	document.getElementById("modeloNave").onclick = function cambiarModeloNave(){
		switch(modeloNave) {
			case 1:
				document.getElementById("imgNave").src="img/nave.png";
				document.getElementById("modeloNave").innerHTML="Modelo con fuego";
				modeloNave=2;
				restart();
				break;
			case 2:
				document.getElementById("imgNave").src="img/navev2.png";
